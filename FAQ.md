...
| **SoundCloud**<br>`https://soundcloud.com`| Fully Working | No known issues. |
| **Deezer**<br>`https://www.deezer.com` | Fully Working | No known issues. | 
...
| **Twitter**<br>`https://twitter.com` | Working as expected | Iframes are not supported, but videos are typically local nowadays. |
